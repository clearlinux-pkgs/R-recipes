...
Version  : 0.1.3
Release  : 11
URL      : https://cran.r-project.org/src/contrib/recipes_0.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/recipes_0.1.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1531886789
