...
Version  : 0.2.0
Release  : 56
URL      : https://cran.r-project.org/src/contrib/recipes_0.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/recipes_0.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645388748
...
/usr/lib64/R/library/recipes/tests/testthat/_snaps/R4.1/selections.md
